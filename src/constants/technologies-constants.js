...
export const ZUSTAND = {
    name: "Zustand",
    icon: "/images/technologies/Zustand.svg",
}

export const TECHNOLOGYLIST = [DOTNET, CYPRESS, CSS_MODULES, JSS, VUE, TYPESCRIPT, TAILWIND, REACT, REACT_ROUTER, PYTHON, PHP, NODE_JS, MYSQL, MONGO_DB, LARAVEL, KOTLIN, JAVASCRIPT, JAVA,FLUTTER, FIREBASE, DART, CSHARP, BOOTSTRAP, ANGULAR, CSS, HTML, POSTGRESQL, ZUSTAND];